...
private final XboxController xboxController1 = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    m_drivetrain.setDefaultCommand(new DriveWithJoystics(() -> xboxController1.getRawAxis(1), () -> xboxController1.getRawAxis(4), m_drivetrain) );
...
joystickButton3.whileHeld(new TowerRun(.5, m_tower) ,true);
...
joystickButton2.whileHeld(new TowerRun(-.5, m_tower) ,true);
